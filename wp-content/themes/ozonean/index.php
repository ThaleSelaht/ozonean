		...
		<div class="row mr-0">
			...
			<div class="col-lg-8 offset-lg-2">
			    ...
			    <div>
			    	<div class="depo-box">
			    		<span>
			    			<img src="./wp-content/uploads/depo.png" alt="">
							<h5>Geovani Alves</h5>
							<h6>Diretor de Arte na Multi In Comunicação</h6>
			    		</span>
			    		<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, est. Eaque nostrum, doloremque veritatis, fugiat deleniti consequatur quisquam porro nobis repudiandae, minima libero totam quibusdam necessitatibus voluptates incidunt cumque officiis, labore ex! Dolorem voluptatibus iure in adipisci fuga, reprehenderit ad vitae labore ipsa, dicta libero voluptas corporis, veniam totam atque. </p>			    		
			    	</div>
			    </div>
			    <div>
			    	<div class="depo-box">
